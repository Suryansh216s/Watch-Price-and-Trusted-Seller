...
def main():
    ...
    if submitted:
        try:
            # Create input data (EXCLUDES Price and Trusted Seller)
            input_data = {
...
#     if submitted:
#         try:
#             # Create input data (EXCLUDES Trusted Seller)
#             input_data = {
#                 'Brand': brand_price_map[brand],
#                 'Movement': 0 if movement == 'Automatic' else 1,
#                 'Case material': case_material_encoder[case_material],
...
#     if submitted:
#         try:
#             # Create input data with all features (excluding Trusted Seller)
#             input_data = {
#                 'Brand': brand_price_map[brand],
#                 'Movement': 0 if movement == 'Automatic' else 1,
#                 'Case material': case_material_encoder[case_material],
...
#             input_df[numerical_features] = scaled_numerical
            
#             # Ensure correct feature order (excluding Trusted Seller)
#             expected_features = [
#                 'Brand', 'Movement', 'Case material', 'Bracelet material', 'Year of production',
#                 'Condition', 'Scope of delivery', 'Gender', 'Availability', 'Shape', 'Face Area',
#                 'Water resistance', 'Crystal', 'Dial', 'Bracelet color', 'Clasp', 'Watches Sold by the Seller',
#                 'Active listing of the seller', 'Fast Shipper', 'Punctuality', 'Seller Reviews'
#             ]
